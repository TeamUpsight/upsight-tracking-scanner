  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-2 md:grid-cols-4 xl:grid-cols-8">
        ...
        <MetricCard label="P95 Duration" value={formatDuration(quality.operational.p95_scan_time_ms)} helper={`Average ${formatDuration(quality.operational.average_scan_time_ms)}`} />
      </div>
      ...
      <div className="grid gap-4 xl:grid-cols-[1.2fr_.8fr]">
        ...
        <Panel title="Operational Health" description="Rates that explain access reliability, retry effectiveness, and external challenge behavior.">
          <div className="grid grid-cols-2 gap-2"><MetricCard label="Proxy Failures" value={formatPercent(quality.operational.proxy_failure_rate)} /><MetricCard label="HTTP 429" value={formatPercent(quality.operational.rate_limit_rate)} /><MetricCard label="Bot Protection" value={formatPercent(quality.operational.bot_rate)} /><MetricCard label="Access Blocked" value={formatPercent(quality.operational.access_block_rate)} /><MetricCard label="Retry Rate" value={formatPercent(quality.operational.retry_rate)} /><MetricCard label="Retry Recovery" value={formatPercent(quality.operational.retry_recovery_rate)} /></div>
        </Panel>
      </div>
    </div>
  );
