...
export const ConsentAuditCodes = {
  ...
  CMP_VERIFICATION_CAPABILITY_UNAVAILABLE: 'CMP_VERIFICATION_CAPABILITY_UNAVAILABLE',
  CMP_VERIFICATION_CAPABILITY_PENDING: 'CMP_VERIFICATION_CAPABILITY_PENDING',
  ...
  CMP_UI_READINESS_TIMEOUT: 'CMP_UI_READINESS_TIMEOUT',
